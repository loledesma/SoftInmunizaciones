Public Class abm_carga
    ...
    Private Sub abm_carga_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub cmd_buscar_Click(sender As Object, e As EventArgs) Handles cmd_buscar.Click
        ...
        Dim sql As String = "SELECT * FROM CARGA WHERE id = " & Me.txt_id_carga.Text

        tabla = acceso.consulta(sql)

        If Not (tabla.Rows.Count() = 0) Then
            Me.dgv_carga.Rows.Clear()
            Me.dgv_carga.Rows.Add()
            Me.dgv_carga.Rows(0).Cells("id_carga").Value = tabla.Rows(0)("id")
            Me.dgv_carga.Rows(0).Cells("descripcion").Value = tabla.Rows(0)("descripcion")
        Else
            MessageBox.Show("No existe ese estado de carga", "Error", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Me.txt_id_carga.Focus()
            Exit Sub
        End If
    ...
    Private Sub cargar_grilla()
        Dim tabla As New DataTable
        Dim sql As String = "SELECT * FROM CARGA"
        tabla = acceso.consulta(sql)
        ...
        For c = 0 To tabla.Rows.Count() - 1
            Me.dgv_carga.Rows.Add()
            Me.dgv_carga.Rows(c).Cells("id_carga").Value = tabla.Rows(c)("id")
            Me.dgv_carga.Rows(c).Cells("descripcion").Value = tabla.Rows(c)("descripcion")
        Next
    End Sub

    Private Sub grid_carga_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgv_carga.CellDoubleClick

        Dim tabla As New DataTable
        Dim sql As String = ""
        sql = " SELECT * FROM CARGA "
        sql &= " WHERE id = " & Me.dgv_carga.CurrentRow.Cells(0).Value
    ...
    Private Sub cmd_nuevo_Click(sender As Object, e As EventArgs) Handles cmd_nuevo.Click
        ...
        Me.txt_id_carga.Text = tabla.Rows.Count() + 1
    ...
    Private Function validar_existencia() As analizar_existencia
        ...
        sql &= "SELECT * FROM CARGA "
        sql &= "WHERE id = " & Me.txt_id_carga.Text
        ...
        If Me.validar() = True Then
            If condicion_estado = estado.insertar Then
                If Me.validar_existencia() = analizar_existencia.no_existe Then
                    Me.insertar()
                Else
                    MessageBox.Show("Ya existe este estado de carga en la base de datos")
                    Exit Sub
                End If
            Else
                Me.modificar()
    ...
    Private Sub insertar()
        ...
        sql &= " VALUES (" & Me.txt_id_carga.Text
    ...
    Private Sub cmd_eliminar_Click(sender As Object, e As EventArgs) Handles cmd_eliminar.Click
        ...
        If MessageBox.Show("¿Esta seguro que desea borrar el registro?", _
            ...
            If IsNumeric(Me.txt_id_carga.Text) Then
