Public Class est_ef_con_y_sin_heladera

    Private Sub est_ef_con_y_sin_heladera_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub est_ef_con_y_sin_heladera_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
    ...
    Private Sub imprimir()
        ...
        sql &= "SELECT E.tiene_heladera AS heladera, COUNT (*) AS cantidad "
        ...
        If tabla.Rows.Count() = 0 Then
            ...
            Exit Sub
        End If
        EST_EFECTORES_CON_Y_SIN_HELADERABindingSource.DataSource = tabla
